...
#include <jni.h>
/* Header for class com_github_teocci_opuslib_OpusTool */

#ifndef _Included_com_github_teocci_opuslib_OpusTool
#define _Included_com_github_teocci_opuslib_OpusTool
#ifdef __cplusplus
extern "C" {
#endif
/*
